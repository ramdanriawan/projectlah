...
<body onLoad="window.print()">
	<center><h2 align="center" style="font-size: 20px"><b>DAFTAR SURAT KELUAR SMA N 4 BANGKO PUSAKO <BR> TAHUN PELAJARAN 2016/2017</h2></center><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<q><?php echo "$tgl1"; ?> sampai dengan <?php echo "$tgl2"; ?></q><br>
<br>
<table border=1><br/>
<tr>
	<tr>
					<th width="3%"><center>NO</center></th>
		            <th width="40%"><center>TUJUAN SURAT</center></th>
					<th width="30%"><center>NOMOR SURAT</center></th>
					<th width="5%"><center>TANGGAL KELUAR</center></th>
</tr>
<?php
$no=1;
$cari=mysql_query("select*from t_surat_keluar where tgl_surat between '$tgl_awal' and '$tgl_akhir'");
...
<td><center>$baca[tujuan]</center></td>
