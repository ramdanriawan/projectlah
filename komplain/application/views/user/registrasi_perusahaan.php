  ...
  <body class="hold-transition register-page">
    <div class="register-box">
      <div class="register-logo">
        <a href="../../index2.html"><b>Registrasi</b>Perusahaan</a>
      </div>
      <div class="register-box-body">
        <p class="login-box-msg">Registrasi member baru</p>
        <form action="<?php echo site_url(); ?>registrasi_perusahaan/insert" method="post" >
          ...
          <div class="form-group has-feedback">
            <select name="kategori_jasa" class="form-control">
              ...
              <option value="pelayanan public">Barang Elektronik</option>
            </select>
            <span class="form-control-feedback"></span>
          </div>
          <br>
        ...
        <a href="<?php echo base_url(); ?>login/perusahaan" class="text-center">Saya sudah memiliki keanggotaan</a>
      </div>
      <!-- /.form-box -->
    </div>
    <!-- /.register-box -->
