...
<div class="wrapper">
    ...
    <section class="sidebar">
     ...
     <ul class="sidebar-menu">
		...
		<a href="#">
          ...
          <ul class="treeview-menu">
            <li class="active treeview"><a href="laporansm.php"><i class="fa fa-circle-o"></i> Laporan Surat Masuk</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Cetak laporan<small>Surat Masuk</small></h1>
      <ol class="breadcrumb">
	  ...
	  <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-solid bg-teal-gradient">
            ...
            <!-- /.box-header -->
<div id="content">
    <form method="post" action="cetaksm.php" target="_blank"></br>
              <div class="box-body">
