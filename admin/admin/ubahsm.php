...
$query = "SELECT * FROM t_surat_masuk WHERE id_surat = $id_surat"; //Memilih nama tabel dan menyeleksi no
 ...
 <li class="active treeview">
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
<form action="aksiubahsm.php" method="post" enctype="multipart/form-data" name="FUpload" id="FUpload" >
						<div class="row">
                            <div class="col-md-12">
                                <input type="hidden" name="id_surat" value="<?php echo $r['id_surat']?>"required>
                                <div class="form-group">
                                    <label>Asal Surat</label>
                                    <input type="text" class="form-control" name="dari" value="<?php echo $r['dari']?>"required>
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                                    <label>Nomor Surat</label>
                                    <input type="text" class="form-control" name="no_surat" value="<?php echo $r['no_surat']?>"required>
                                    <p class="help-block text-danger"></p>
                                </div>
				                <div class="form-group">
...
<div id="datetimepicker" class="input-append date">	
        ...
        <div>
            <img src="<?php echo $r['file'] ?>"  width="200px" height="200px" required>
        </div>
    </div>
    <div class="form-group">
