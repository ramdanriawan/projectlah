...
<div class="box box-primary">
	...
	<div class="box-body">
                ...
                <div class="span9"><input type="text" id="telppemohon" name="No Blangko" class="form-control" readonly="true"/></div>
            </div>
						<div class="form-group">
                <label>Kategori Pelayanan</label>
                <div class="span9"><input type="text" id="kategori" class="form-control" value="<?php echo $layanan;?>" readonly="true"/></div>
            </div>
		</div>
</div>
...
<div class="box box-primary">
	...
	<div class="box-body">
                ...
                <div class="span7"><input type="text" class="form-control" readonly="true"/></div>
            </div>
						<div class="form-group">
                ...
                <div class="span6"><input type="text" class="form-control" id="tgl_estimasi" name="tgl_estimasi" required/></div>
            </div>
						<?php
