...
$id = $_GET['sub'];
$sql = $conn->query("SELECT * FROM ad_sub_kategori WHERE id_kategori = '$id'");
$sql3 = $conn->query("SELECT * FROM ad_kategori WHERE id_kategori = '$id'");
$k = $sql3->fetch_assoc();
...
<table width="853" border="0" align="center" cellpadding="4" cellspacing="0">
  ...
  <tr>
    <td height="46" colspan="4" align="center" valign="middle"><strong>REKAPITULASI PELAYANAN  PER SUB PELAYANAN </strong></td>
  </tr>
  <tr>
    <td height="52" colspan="4"><table width="200" height="38" border="0" cellpadding="0" cellspacing="0" class="font">
      <tr>
        <td width="80"><strong>BULAN</strong></td>
        <td width="10"><strong>:</strong></td>
        <td width="117"><strong><?php echo bulan($_GET['bulan']).' '.date('Y');?></strong></td>
      </tr>
      <tr>
  ...
  <tr>
    <td height="155" colspan="4" align="center" valign="top">
	<table cellpadding="3" cellspacing="0" width="100%" class="font" border=1>
      <thead>
        <tr>
          <th width="3%" bgcolor="#CCCCCC">NO</th>
          <th width="51%" align="left" bgcolor="#CCCCCC"> JENIS SUB PELAYANAN </th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td valign="middle"><?php echo $r['nama_sub_kategori'];?></td>
