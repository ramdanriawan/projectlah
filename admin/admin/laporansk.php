...
<li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active treeview"><a href="laporansk.php"><i class="fa fa-circle-o"></i> Laporan Surat Keluar</a></li>
          </ul>
        </li>
		<li class=" treeview">
          <a href="user.php">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Cetak laporan<small>Surat Keluar</small></h1>
      <ol class="breadcrumb">
          ...
          <div class="box box-solid bg-teal-gradient">
            <div class="box-header">
              ...
              <div class="pull-right box-tools">
                <button type="button" class="btn btn-primary btn-sm pull-right" data-widget="collapse" data-toggle="tooltip" title="slide" style="margin-right: 5px;">
            ...
            <!-- /.box-header -->
<div id="content">
    <form method="post" action="cetaksk.php" target="_blank"></br>
              <div class="box-body">
