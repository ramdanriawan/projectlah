			...
			<div class="row-fluid">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Detail Registrasi akta Mati</h3>
					</div>
					<!-- /.box-header -->
					<!-- form start -->
					<div class="box-body">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="form-group">
                            ...
                            <div class="span7"><input type="text" readonly="true"/></div>
                        </div>
						</div>
						<!-- Ajax Form -->
						<div class="form-group">
						...
						<div class="form-group">
                            ...
                            <div class="span7">
                                <select name="select" name="subkategori" id="subkategori" class="form-control" onchange="tampil_syarat();">
