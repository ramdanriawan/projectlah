...
<div class="wrapper">
     ...
     <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active treeview"><a href="suratmasuk.php"><i class="fa fa-circle-o"></i> Surat Masuk</a></li>
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
			<form action="tambahsm.php" method="post" enctype="multipart/form-data" name="FUpload" id="FUpload">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="dari"class="form-control" id="exampleInputEmail1" placeholder="Masukan Asal Surat" value="<?php echo !empty($dari)?$dari:'';?>" required>
                </div>
				                <div class="form-group">
                  <label for="exampleInputEmail1">Nomor Surat</label>
                  <input type="text" name="no_surat"class="form-control" id="exampleInputEmail1" placeholder="Masukan nomor Surat" value="<?php echo !empty($no_surat)?$no_surat:'';?>" required>
                </div>
		  ...
		  <i class="icon-calendar"></i>
				...
				<div class="form-group">
                  ...
                  <textarea name="isi_ringkas" class="form-control" rows="3" placeholder="Masukkan Isian Ringkas Surat" value="<?php echo !empty($isi_ringkas)?$isi_ringkas:'';?>" required></textarea>
                </div>
                <div class="form-group">
                  <label for="exampleInputFile"required>File Scan</label>
                  <input name="file" type="file" class="form-control" id="exampleInputFile" value="<?php echo !empty($file)?$file:'';?>" />
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
<?php
	$q = mysql_query("select * from t_surat_masuk");
 ...
 <td width="30%"><?php echo $r['dari'];?></td>
 <td width="20%"><?php echo $r['no_surat'];?></td>
 <td width="12%"><center><?php echo $r['tgl_surat'];?></center></td>
  <td width="10%"><center>
  <a class="btn btn-success" href="ubahsm.php?id_surat=<?php echo $r['id_surat'];?>" title="Edit Data"><i class="fa fa-edit"></i></a>&nbsp; 
  <a class="btn btn-danger"  href="#" name="hapus" data-href="hapussm.php?id_surat=<?php echo $r['id_surat'];?> "data-toggle="modal" data-target="#confirm-delete" title="Hapus"><i class="fa fa-trash"></i></a></center></td>	
  </tr>
	 			<?php
}?>
                </tbody>
