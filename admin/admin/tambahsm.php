...
$simpan=mysql_query ("INSERT INTO t_surat_masuk(id_surat,id_admin,dari,no_surat,tgl_surat,isi_ringkas,file)  " .
  "values('$id_surat','$id_admin','$dari','$no_surat','$tgl_surat','$isi_ringkas','$gambar')")  or die(mysql_error());
 	}}}
 mysql_query($simpan);
