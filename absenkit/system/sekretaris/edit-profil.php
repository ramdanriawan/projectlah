...
echo '<title>Edit Profil - Absen Kit</title>';
		...
		<div class="container-fluid">
			...
			<section class="card">
				...
				<div class="card-block"> 
					<div class="row">
						<form id="form-insert" name="form-insert" action="page.php?s-process-edit-profil" enctype="multipart/form-data" method="POST">
