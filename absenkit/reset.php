					...
					<div class="table-responsive">
								<table id="table-sm" class="table table-bordered table-hover table-sm">
									...
									<tbody>
										...
										<td align="center">:</td>
										<td align="left"><a href='mailto:cusnix@gmail.com' onClick='_blank'>Cusnix@gmail.com</a></td>
										</tr> 
										
										<tr>
										<td align="right"><i class="font-icon font-icon-phone"></i> Phone </td>
										<td align="center">:</td>
										<td align="left"><a href='sms:082216532273?body=ORDER%20Lupa%20Kata%20Sandi%20Username' target='_blank'>(+62)82214121989</a></td>
										</tr> 
										
										<tr>
										<td align="right"><i class="font-icon font-icon-fb-fill"></i> FB </td>
										<td align="center">:</td>
										<td align="left"><a href="//fb.me/cusnix">Husnii</a></td>
										</tr> 
										
										<tr>
										<td align="right"><i class="font-icon font-icon-comments-2"></i> BBM </td>
										<td align="center">:</td>
										<td align="left"><a href='bbmi://D38EC5FB' target='_blank'>D38EC5FB</a></td>
										</tr> 
									</tbody>
								</table>
							</div>
					  	<br>
          			<p class="sign-note">Copyright &copy;  <?php echo "".date("Y");""; ?>  - <a href="page.php?masuk">AbsenKit</a>  (Absensi Siswa Berbasis Web)</p>
				 </form>
