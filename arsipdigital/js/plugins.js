$(document).ready(function(){
   ...
   // TOOLTIPS
        ...
        // WYSIWIG HTML EDITOR    
         ...
         {
            $("#tSortable").dataTable({"iDisplayLength": 10, "aLengthMenu": [10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": false }, null, null, null, null]});
         ...
         if($("#uploader_v5").length > 0){
            $("#uploader_v5").pluploadQueue({		
                    ...
                    filters : [
                            {title : "Type files", extensions : "jpg,gif,png,pdf,zip,rar"},
